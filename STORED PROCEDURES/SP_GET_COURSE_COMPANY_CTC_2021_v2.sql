...
USE [SDA2021]
GO
IF EXISTS (SELECT 1 FROM sys.procedures WHERE name = 'sp_get_Course_Company_CTC_2021_v2')
	DROP PROCEDURE sp_get_Course_Company_CTC_2021_v2  
GO

CREATE PROCEDURE sp_get_Course_Company_CTC_2021_v2
AS
